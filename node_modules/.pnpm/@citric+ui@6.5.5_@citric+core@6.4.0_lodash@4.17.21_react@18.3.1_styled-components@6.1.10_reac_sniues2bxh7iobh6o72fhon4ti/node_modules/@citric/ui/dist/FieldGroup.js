...
import { getRadius } from '@citric/core/dist/utils/theme.js';
const getBorderLastChildStyle = (theme) => css `
...
`;
const getBorderFirstChildStyle = (theme) => css `
  border-radius: ${getRadius(theme, 'xs')};
...
`;
const FieldGroup = styled.div.withConfig(defaultConfig) `
  width: 100%;
