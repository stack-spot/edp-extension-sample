...
import { getColor, getFontFamily, getFontStyle, getFontWeight, getSpacing, } from '@citric/core/dist/utils/theme.js';
...
`;
export const Table = styled.table.withConfig(defaultConfig) `
...
`;
export const Thead = styled.thead.withConfig(defaultConfig) `
  box-sizing: border-box;
  ${extendStyle('Thead')};
  ${overwriteStyle('Thead')};
`;
export const Tbody = styled.tbody.withConfig(defaultConfig) `
  box-sizing: border-box;
  ${extendStyle('Tbody')};
  ${overwriteStyle('Tbody')};
`;
export const Tr = styled.tr.withConfig(defaultConfig) `
  box-sizing: border-box;
  ${extendStyle('Tr')};
  ${overwriteStyle('Tr')};
`;
export const Td = styled.td.withConfig(defaultConfig) `
  box-sizing: border-box;
  ...
  ${overwriteStyle('Td')};
`;
export const Th = styled.th.withConfig(defaultConfig) `
  box-sizing: border-box;
  padding: ${({ theme }) => `${getSpacing(theme, 6)} ${getSpacing(theme, 5)}`};
