import { colorIsColorScheme, colorIsPalette } from '@citric/core';
...
import { getColor, getIconButtonSize, getRadius } from '@citric/core/dist/utils/theme.js';
...
export const IconButton = styled.button.withConfig(defaultConfig) `
  ...
  &:hover,
  &:focus {
    ${({ theme, appearance, color }) => (color && (appearance !== 'text') && (appearance !== undefined)) ?
