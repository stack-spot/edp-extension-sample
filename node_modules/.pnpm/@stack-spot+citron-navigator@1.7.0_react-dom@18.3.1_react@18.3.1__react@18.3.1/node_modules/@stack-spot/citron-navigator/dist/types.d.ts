...
export type ContextualizedRoute<T, CurrentParams extends Record<string, any> | void> = T extends Route<infer Parent, infer Params> ? (Route<ContextualizedRoute<Parent, CurrentParams>, MakeCurrentParamsOptional<CurrentParams, Params>> & {
