import { NetworkConfig } from '@stack-spot/portal-extension-commons'
import {
  accountClient,
  agentClient,
  aiClient,
...
function buildClientConfig(client: any): Record<string, number> {
...
export function buildNetworkConfig(): NetworkConfig {
  return {
