import { createSuccessfulResponseMessage, createUnsuccessfulResponseMessage, } from '@stack-spot/portal-extension-commons';
...
export class MessageHandler {
    ...
    async handleRequest(message) {
        ...
        try {
            ...
            errorMessage ||= `${error}`;
            response = createUnsuccessfulResponseMessage(message.operation, message.id, errorMessage);
        }
