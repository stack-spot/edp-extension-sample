...
import { ExtensionConfigMessage, ExtensionOperations, ExtensionReadyMessage, ExtensionRequestMessage, ExtensionResizeMessage, SuccessfulExtensionResponseMessage, UnsuccessfulExtensionResponseMessage } from './types';
...
export declare function createUnsuccessfulResponseMessage<T extends keyof ExtensionOperations>(operation: T, id: number, error: string): UnsuccessfulExtensionResponseMessage;
export {};
