...
type DefaultWeight = DefaultTheme['font']['weight'] | {
    [key: string]: number;
};
type DefaultFamily = DefaultTheme['font']['family'] | {
    [key: string]: string;
};
type DefaultColorScheme = DefaultTheme['colorScheme']['primary'] | {
    [key: string]: string;
};
export interface Theme<F extends DefaultFamily, W extends DefaultWeight, C extends DefaultColorScheme> {
    colorScheme?: {
        primary?: C;
        secondary?: C;
        highlight?: C;
...
declare function extendTheme(theme: any): any;
