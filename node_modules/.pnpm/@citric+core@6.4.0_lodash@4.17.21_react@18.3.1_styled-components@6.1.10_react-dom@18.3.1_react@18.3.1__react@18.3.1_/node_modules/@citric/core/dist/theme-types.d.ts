...
type GlobalStyle = CssProperties & {
...
type FontAppearancesKeys = 'breadcrumb' | 'button' | 'body1' | 'body2' | 'code1' | 'code2' | 'display1' | 'h1' | 'h2' | 'h3' | 'h4' | 'h5' | 'h6' | 'microtext1' | 'overheader1' | 'overheader2' | 'subtitle1' | 'subtitle2' | 'subtitle3' | 'subtitle4';
type ColorSchemeKeys = 'primary' | 'secondary' | 'tertiary' | 'success' | 'warning' | 'danger' | 'light' | 'inverse' | 'highlight';
type ColorSchemeVariants = 300 | 400 | 500 | 600 | 700 | 'contrastText';
type PaletteKeys = 'blue' | 'cyan' | 'gray' | 'indigo' | 'moss' | 'orange' | 'pink' | 'purple' | 'red' | 'teal' | 'yellow';
