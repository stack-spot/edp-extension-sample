...
import "./chunk-WUO3U7VK.js";
import "./chunk-WRWZMEG7.js";
import {
  require_jsx_runtime
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension-commons@0.3.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_sty_pd3xityxcpg6swu27mbhrwfpiq/node_modules/@stack-spot/portal-extension-commons/dist/factory.js
var id = 0;
function next() {
...
function createResizeMessage(width, height) {
  return {
    signal: "resize",
    id: next(),
    type: "stackspot-extension-message",
...
function createRequestMessage(...[operation, variables]) {
  return {
    type: "stackspot-extension-message",
    id: next(),
    signal: "request",
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension-commons@0.3.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_sty_pd3xityxcpg6swu27mbhrwfpiq/node_modules/@stack-spot/portal-extension-commons/dist/url.js
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/network/config.js
var config;
var resolve;
var promise = new Promise((r) => {
  resolve = r;
});
function networkConfigReady() {
  return promise;
}
function getNetworkConfig() {
  return config;
}
function setNetworkConfig(clients) {
  config = clients;
  resolve();
}

// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/MessageHandler.js
var MessageHandler = class {
  ...
  messageAsResponse(message) {
    return !message || typeof message != "object" || message.type != "stackspot-extension-message" || message.signal != "response-success" && message.signal != "response-error" && message.signal != "config" ? void 0 : message;
  }
  setupListeners() {
    window.addEventListener("message", (event) => {
      ...
      if (message) {
        switch (message.signal) {
          case "response-error":
            (_b = (_a11 = this.promiseMap.get(message.id)) == null ? void 0 : _a11.reject) == null ? void 0 : _b.call(_a11, new Error(message.error));
            break;
          case "response-success":
            (_d = (_c = this.promiseMap.get(message.id)) == null ? void 0 : _c.resolve) == null ? void 0 : _d.call(_c, message);
            break;
          case "config":
  ...
  sendRequest(request) {
    ...
    return new Promise((resolve2, reject) => {
      this.promiseMap.set(request.id, { resolve: resolve2, reject });
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/layout.js
async function showModal(options) {
  await messageHandler.sendRequest(createRequestMessage("showModal", options));
}
async function showRightPanel(options) {
...
async function showCustomRightPanel(options) {
...
async function showToaster(options) {
...
function createRetryer(config2) {
  ...
  const cancel = (cancelOptions) => {
    ...
    if (!isResolved) {
      ...
      (_a11 = config2.abort) == null ? void 0 : _a11.call(config2);
    }
  };
  const cancelRetry = () => {
  ...
  const resolve2 = (value) => {
    ...
    if (!isResolved) {
      isResolved = true;
      (_a11 = config2.onSuccess) == null ? void 0 : _a11.call(config2, value);
  ...
  const reject = (value) => {
    ...
    if (!isResolved) {
      isResolved = true;
      (_a11 = config2.onError) == null ? void 0 : _a11.call(config2, value);
      continueFn == null ? void 0 : continueFn();
  ...
  const pause = () => {
    return new Promise((continueResolve) => {
      ...
      (_a11 = config2.onPause) == null ? void 0 : _a11.call(config2);
    }).then(() => {
      var _a11;
      continueFn = void 0;
      if (!isResolved) {
        (_a11 = config2.onContinue) == null ? void 0 : _a11.call(config2);
      }
    });
  };
  const run = () => {
    ...
    Promise.resolve(promiseOrValue).then(resolve2).catch((error) => {
      ...
      failureCount++;
      (_a11 = config2.onFail) == null ? void 0 : _a11.call(config2, failureCount, error);
      sleep(delay).then(() => {
...
var Query = (_a4 = class extends Removable {
  ...
  cancel(options) {
    var _a11, _b;
    const promise2 = (_a11 = __privateGet(this, _retryer)) == null ? void 0 : _a11.promise;
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useQueries.js
var React5 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/QueryClientProvider.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/isRestoring.js
var React2 = __toESM(require_react(), 1);
var IsRestoringContext = React2.createContext(false);
var useIsRestoring = () => React2.useContext(IsRestoringContext);
var IsRestoringProvider = IsRestoringContext.Provider;

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/QueryErrorResetBoundary.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/errorBoundaryUtils.js
var React4 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/utils.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/suspense.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useBaseQuery.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useQuery.js
function useQuery(options, queryClient2) {
  return useBaseQuery(options, QueryObserver, queryClient2);
}

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useSuspenseQuery.js
...
// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/HydrationBoundary.js
var React7 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useIsFetching.js
var React8 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useMutationState.js
var React9 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@tanstack+react-query@5.59.20_react@18.3.1/node_modules/@tanstack/react-query/build/modern/useMutation.js
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/network/NetworkObject.js
var queryClient;
var NetworkObject = class {
  ...
  getVariablesAndOptions(args) {
    const variables = this.arity === 1 ? void 0 : args[0];
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/network/proxy.js
function createNetworkProxy(name) {
  let networkObjects;
  function init() {
    const config2 = getNetworkConfig();
    const methods = config2[name];
    if (!methods) {
      throw new Error(`${name} is not a valid network client. Valid clients are: ${Object.keys(config2).join(", ")}.`);
    }
    networkObjects = {};
  ...
  return new Proxy({}, {
    get(_, property) {
      if (!networkObjects)
        init();
      const networkObject = networkObjects == null ? void 0 : networkObjects[String(property)];
      if (!networkObject) {
...
// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/network/clients.js
var cloudRuntimesClient = createNetworkProxy("cloudRuntimesClient");
var aiClient = createNetworkProxy("aiClient");
var agentClient = createNetworkProxy("agentClient");
var cloudAccountClient = createNetworkProxy("cloudAccountClient");
var accountClient = createNetworkProxy("accountClient");
var secretsClient = createNetworkProxy("secretsClient");
var cloudServicesClient = createNetworkProxy("cloudServicesClient");
var cloudPlatformClient = createNetworkProxy("cloudPlatformClient");
var contentClient = createNetworkProxy("contentClient");
var eventBusClient = createNetworkProxy("eventBusClient");
var insightsClient = createNetworkProxy("insightsClient");
var workflowClient = createNetworkProxy("workflowClient");
var workspaceClient = createNetworkProxy("workspaceClient");
var notificationClient = createNetworkProxy("notificationClient");
var runtimeManagerClient = createNetworkProxy("runtimeManagerClient");
var cloudPlatformHorizonClient = createNetworkProxy("cloudPlatformHorizonClient");
var workspaceSearchClient = createNetworkProxy("workspaceSearchClient");
var workspaceManagerClient = createNetworkProxy("workspaceManagerClient");

// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/portal-data.js
async function getUserData() {
  const response = await messageHandler.sendRequest(createRequestMessage("getUserData"));
  return response.result;
}
async function getCurrentPage() {
  const response = await messageHandler.sendRequest(createRequestMessage("getCurrentPage"));
  return response.result;
}

// ../../node_modules/.pnpm/@stack-spot+portal-extension@0.5.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-comp_dzlyijfitqsy6txykwbt7nf5lu/node_modules/@stack-spot/portal-extension/dist/StackspotExtension.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
import "/home/nataliesilva/Documentos/portal-workspace/packages/edp-extension-sample/node_modules/.pnpm/@stack-spot+portal-theme@1.1.0_@citric+core@6.4.0_lodash@4.17.21_react@18.3.1_styled-componen_w3kidsfeh3vscgmou6wwqrubii/node_modules/@stack-spot/portal-theme/dist/theme.css";
var import_react = __toESM(require_react(), 1);
var StackspotExtension = ({ children }) => {
  const [isReady, setReady] = (0, import_react.useState)(false);
  const queryClient2 = useQueryClient(new QueryClient({ defaultOptions: { queries: { refetchOnWindowFocus: false } } }));
  ...
  return isReady && (0, import_jsx_runtime3.jsx)(QueryClientProvider, { client: queryClient2, children: (0, import_jsx_runtime3.jsx)(CSSToCitricAdapter, { children }) });
};
export {
  StackspotExtension,
  accountClient,
...
//# sourceMappingURL=@stack-spot_portal-extension.js.map
